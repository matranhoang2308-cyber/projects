...
const baseCustomers: Customer[] = [
  ...
  // ══════════════════════════════════════════════════════════════════════════
  {
    ...
    contracts: [
      {
        id: "c1-1",
        contractCode: "HĐ-VGP-2025-001",
        projectName: "Vinhomes Grand Park",
        tower: "S1",
        unit: "S1.05-12",
        productType: "Sky Garden",
        paymentMethod: "Trả góp",
        salesperson: "Lâm Trà My",
        contractValue: 4.5,
        paidAmount: 3.375,
        paymentProgress: 75,
        dueDate: "2025-12-20",
  ...
  // ══════════════════════════════════════════════════════════════════════════
  {
    ...
    contracts: [
      ...
      {
        id: "c2-1",
        contractCode: "HĐ-TSA-2026-001",
        projectName: "The Sun Avenue",
        tower: "B3",
        unit: "B3.08-22",
        productType: "Penhouse",
        paymentMethod: "Trả góp",
        salesperson: "Nguyễn Hoàng Phúc",
        contractValue: 3.2,
        paidAmount: 1.28,
        paymentProgress: 40,
        dueDate: "2026-04-30",
      ...
      {
        id: "c2-2",
        contractCode: "HĐ-AKC-2026-001",
        projectName: "Akari City",
        tower: "B1",
        unit: "B1.09-03",
        productType: "Duplex Garden",
        paymentMethod: "Thanh toán theo tiến độ",
        salesperson: "AKH Realty",
        contractValue: 2.8,
        paidAmount: 0.7,
        paymentProgress: 25,
        dueDate: "2026-07-15",
  ...
  // ══════════════════════════════════════════════════════════════════════════
  {
    ...
    contracts: [
      ...
      {
        id: "c3-1",
        contractCode: "HĐ-MTD-2025-003",
        projectName: "Masteri Thảo Điền",
        tower: "MT2",
        productType: "Sky Villa Residence",
        paymentMethod: "Trả góp",
  ...
  // ══════════════════════════════════════════════════════════════════════════
  {
    ...
    contracts: [
      {
        id: "c5-1",
        contractCode: "HĐ-MPH-2025-001",
        projectName: "Midtown Phú Mỹ Hưng",
        tower: "M5",
        productType: "Penhouse",
        paymentMethod: "Thanh toán theo tiến độ",
        salesperson: "Đất Xanh Miền Bắc",
        unit: "M1.06-03",
        contractValue: 7.3,
        paidAmount: 1.46,
        paymentProgress: 20,
  ...
  // ══════════════════════════════════════════════════════════════════════════
  {
    ...
    contracts: [
      ...
      {
        id: "c6-1",
        contractCode: "HĐ-PMC-2025-001",
        projectName: "Palm City",
        tower: "P3",
        unit: "P3.09-17",
        productType: "Sky Villa Residence",
        paymentMethod: "Trả góp",
        salesperson: "Cen Land",
        contractValue: 4.0,
        paidAmount: 2.4,
        paymentProgress: 60,
        dueDate: "2026-05-20",
      ...
      {
        id: "c6-2",
        contractCode: "HĐ-TSA-2026-005",
        projectName: "The Sun Avenue",
        tower: "C2",
        unit: "C2.08-14",
        productType: "Penhouse",
        paymentMethod: "Thanh toán theo tiến độ",
        salesperson: "NewstarLand",
        contractValue: 5.5,
        paidAmount: 0.55,
        paymentProgress: 10,
        dueDate: "2026-04-10",
